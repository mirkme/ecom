...
$stmt = $conn->prepare("INSERT INTO wishlist(pid, productname, productquantity, productprice, productcategory, productcolour, productlink, customerid, added_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())");
